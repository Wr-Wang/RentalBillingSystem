...
{
    /// <inheritdoc />
    public partial class CreateUsersAuditTable : Migration
    {
        /// <inheritdoc />
...
CREATE INDEX [IX_Users_Audit_EntityId] ON [Users_Audit] ([Id]);
CREATE INDEX [IX_Users_Audit_ChangedAt] ON [Users_Audit] ([AuditChangedAt] DESC);
");
        }
        ...
        {
            migrationBuilder.Sql("DROP TABLE [Users_Audit];");
        }
    }
}
