...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Users_Audit', @level2type = N'COLUMN', @level2name = N'HomeCompanyId';
...
CREATE TABLE [UserRoles_Audit] (
    ...
    [RoleId] UNIQUEIDENTIFIER , -- 角色ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
);
GO

-- UserRoles_Audit 表说明：用户角色关联表审计
...
-- UserRoles_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'用户ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'UserId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'角色ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'RoleId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserRoles_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO
...
-- ===================================================================
-- UserCompanyScope_Audit 表：用户公司数据权限表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[UserCompanyScope_Audit]'))
CREATE TABLE [UserCompanyScope_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
...
-- UserCompanyScope_Audit 表说明：用户公司数据权限表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'用户公司数据权限表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit';
GO

-- UserCompanyScope_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'用户ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'UserId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'UserCompanyScope_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_UserCompanyScope_Audit_Id_Version] ON [UserCompanyScope_Audit]([Id], [AuditVersionNo]);
...
CREATE TABLE [RoleMenus_Audit] (
    ...
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [RoleId] UNIQUEIDENTIFIER , -- 角色ID,
    [MenuId] UNIQUEIDENTIFIER , -- 菜单ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
);
GO

-- RoleMenus_Audit 表说明：角色菜单权限表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'角色菜单权限表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit';
GO

-- RoleMenus_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'角色ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'RoleId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'菜单ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'MenuId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoleMenus_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_RoleMenus_Audit_Id_Version] ON [RoleMenus_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ApprovalBizData_Audit 表：审批业务数据表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[ApprovalBizData_Audit]'))
CREATE TABLE [ApprovalBizData_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
...
-- ApprovalBizData_Audit 表说明：审批业务数据表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审批业务数据表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit';
GO

-- ApprovalBizData_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审批请求ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ApprovalRequestId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ContractNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'变更类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ChangeType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'生效日期', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'EffectiveDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'旧金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'OldAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'新金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'NewAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'原因说明', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'Reason';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'终止类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'TerminateType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'实际搬离日', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ActualEndDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'押金处理', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'DepositReturn';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否已处理', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'IsProcessed';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'处理时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'ProcessedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalBizData_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ApprovalBizData_Audit_Id_Version] ON [ApprovalBizData_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ApprovalFeeItems_Audit 表：审批调价明细表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[ApprovalFeeItems_Audit]'))
CREATE TABLE [ApprovalFeeItems_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [FeeName] NVARCHAR(100) , -- 费用名称,
    [OldAmount] DECIMAL(18,2) , -- 原价,
...
-- ApprovalFeeItems_Audit 表说明：审批调价明细表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审批调价明细表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit';
GO

-- ApprovalFeeItems_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审批请求ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'ApprovalRequestId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用项目ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'FeeCodeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用名称', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'FeeName';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'原价', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'OldAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'新价', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'NewAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'计费方式', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'BillingMode';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'计量单位', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'Unit';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ApprovalFeeItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ApprovalFeeItems_Audit_Id_Version] ON [ApprovalFeeItems_Audit]([Id], [AuditVersionNo]);
...
CREATE TABLE [Buildings_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [Code] VARCHAR(50) , -- 楼栋编号,
    [Name] NVARCHAR(200) , -- 楼栋名称,
...
-- Buildings_Audit 表说明：楼栋表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼栋表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit';
GO

-- Buildings_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼栋编号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'Code';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼栋名称', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'Name';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'地址', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'Address';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'产权类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'PropertyType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否启用', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'IsActive';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Buildings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_Buildings_Audit_Id_Version] ON [Buildings_Audit]([Id], [AuditVersionNo]);
...
CREATE TABLE [Floors_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [BuildingId] UNIQUEIDENTIFIER , -- 所属楼栋ID,
    [FloorNo] INT , -- 楼层号,
    [FloorName] NVARCHAR(100) , -- 楼层名称,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 , -- 创建时间,
...
-- Floors_Audit 表说明：楼层表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼层表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit';
GO

-- Floors_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属楼栋ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'BuildingId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼层号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'FloorNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼层名称', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'FloorName';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Floors_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_Floors_Audit_Id_Version] ON [Floors_Audit]([Id], [AuditVersionNo]);
...
CREATE TABLE [HousingUnits_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [FloorId] UNIQUEIDENTIFIER , -- 所属楼层ID,
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属楼层ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'HousingUnits_Audit', @level2type = N'COLUMN', @level2name = N'FloorId';
...
-- ===================================================================
-- BuildingFloorLevelConfigs_Audit 表：楼栋楼层级别映射表审计
-- ===================================================================
...
-- BuildingFloorLevelConfigs_Audit 表说明：楼栋楼层级别映射表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼栋楼层级别映射表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit';
GO

-- BuildingFloorLevelConfigs_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼栋ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'BuildingId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'楼层级别ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'FloorLevelBandId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'起始楼层号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'FloorNoFrom';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'结束楼层号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'FloorNoTo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BuildingFloorLevelConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_BuildingFloorLevelConfigs_Audit_Id_Version] ON [BuildingFloorLevelConfigs_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- RoomFeeDefaults_Audit 表：房间默认费用表审计
-- ===================================================================
...
-- RoomFeeDefaults_Audit 表说明：房间默认费用表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'房间默认费用表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit';
GO

-- RoomFeeDefaults_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'房型ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'RoomTypeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用项目ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'FeeCodeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'默认金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'DefaultAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'RoomFeeDefaults_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_RoomFeeDefaults_Audit_Id_Version] ON [RoomFeeDefaults_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ContractTenants_Audit 表：合同租客关联表审计
-- ===================================================================
...
CREATE TABLE [ContractTenants_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [ContractId] UNIQUEIDENTIFIER , -- 合同ID,
    [TenantId] UNIQUEIDENTIFIER , -- 租客ID,
    [IsPrimary] BIT , -- 是否主租客,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
);
...
-- ContractTenants_Audit 表说明：合同租客关联表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同租客关联表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit';
GO

-- ContractTenants_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'租客ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'TenantId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否主租客', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'IsPrimary';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ContractTenants_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ContractTenants_Audit_Id_Version] ON [ContractTenants_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ChangeRequests_Audit 表：变更请求表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[ChangeRequests_Audit]'))
CREATE TABLE [ChangeRequests_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
...
-- ChangeRequests_Audit 表说明：变更请求表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'变更请求表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit';
GO

-- ChangeRequests_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'变更类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'ChangeType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'生效日期', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'EffectiveDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'原因', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'Reason';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'批量分组ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'BatchId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审批请求ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'ApprovalRequestId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequests_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ChangeRequests_Audit_Id_Version] ON [ChangeRequests_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ChangeRequestItems_Audit 表：变更请求明细表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[ChangeRequestItems_Audit]'))
CREATE TABLE [ChangeRequestItems_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [ChangeRequestId] UNIQUEIDENTIFIER , -- 变更请求ID,
    [TargetType] VARCHAR(20) , -- 目标类型,
    [TargetId] UNIQUEIDENTIFIER , -- 目标ID,
    [FieldName] VARCHAR(50) , -- 字段名,
    [OldValue] NVARCHAR(100) , -- 旧值,
    [NewValue] NVARCHAR(100) , -- 新值,
    [OldValueDecimal] DECIMAL(18,2) , -- 旧值-数值,
    [NewValueDecimal] DECIMAL(18,2) , -- 新值-数值,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
...
-- ChangeRequestItems_Audit 表说明：变更请求明细表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'变更请求明细表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit';
GO

-- ChangeRequestItems_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'变更请求ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'ChangeRequestId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'目标类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'TargetType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'目标ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'TargetId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'字段名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'FieldName';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'旧值', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'OldValue';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'新值', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'NewValue';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'旧值-数值', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'OldValueDecimal';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'新值-数值', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'NewValueDecimal';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ChangeRequestItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ChangeRequestItems_Audit_Id_Version] ON [ChangeRequestItems_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- MeterReadings_Audit 表：抄表记录表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[MeterReadings_Audit]'))
CREATE TABLE [MeterReadings_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [ReadingSource] VARCHAR(20) , -- 来源,
    [ReadingStatus] VARCHAR(20) , -- 状态,
    [IsEstimated] BIT , -- 是否估算,
    [EstimationMethod] VARCHAR(50) , -- 估算方法,
    [ReceivablePlanId] UNIQUEIDENTIFIER , -- 应收计划ID,
    [Remarks] NVARCHAR(500) , -- 备注,
    [CompanyId] UNIQUEIDENTIFIER , -- 所属公司ID,
...
-- MeterReadings_Audit 表说明：抄表记录表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'抄表记录表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit';
GO

-- MeterReadings_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用项目ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'FeeCodeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'房间ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'RoomId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账期年份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'PeriodYear';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账期月份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'PeriodMonth';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'上期读数', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'PreviousReading';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'本期读数', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CurrentReading';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'用量', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'Consumption';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'单价', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'UnitPrice';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'Amount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'来源', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'ReadingSource';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'ReadingStatus';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否估算', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'IsEstimated';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'估算方法', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'EstimationMethod';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'应收计划ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'ReceivablePlanId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'备注', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'Remarks';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterReadings_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_MeterReadings_Audit_Id_Version] ON [MeterReadings_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- MeterEstimationConfigs_Audit 表：估读配置表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[MeterEstimationConfigs_Audit]'))
CREATE TABLE [MeterEstimationConfigs_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [FeeCodeId] UNIQUEIDENTIFIER , -- 费用项目ID,
    [Method] VARCHAR(50) , -- 估读方法,
    [OverdueDaysThreshold] INT , -- 逾期天数,
    [IsActive] BIT , -- 是否启用,
    [CompanyId] UNIQUEIDENTIFIER , -- 所属公司ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 , -- 创建时间,
...
-- MeterEstimationConfigs_Audit 表说明：估读配置表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'估读配置表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit';
GO

-- MeterEstimationConfigs_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用项目ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'FeeCodeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'估读方法', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'Method';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'逾期天数', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'OverdueDaysThreshold';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否启用', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'IsActive';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MeterEstimationConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_MeterEstimationConfigs_Audit_Id_Version] ON [MeterEstimationConfigs_Audit]([Id], [AuditVersionNo]);
...
-- ReceivablePlans_Audit 表说明：应收计划表审计
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账期年份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'PeriodYear';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账期月份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'PeriodMonth';
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'已收金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'ReceivedAmount';
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'税率', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'TaxRate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'税额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'TaxAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'计算说明', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'Description';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceivablePlans_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
...
-- ===================================================================
-- DebitNoteItems_Audit 表：账单明细表审计
-- ===================================================================
...
-- DebitNoteItems_Audit 表说明：账单明细表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账单明细表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit';
GO

-- DebitNoteItems_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'账单ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'DebitNoteId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用项目ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'FeeCodeId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'费用名称', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'FeeName';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'Amount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'已收金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'ReceivedAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'数量', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'Quantity';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'单价', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'UnitPrice';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'单位', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'Unit';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'说明', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'Description';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'排序', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'SortOrder';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'DebitNoteItems_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_DebitNoteItems_Audit_Id_Version] ON [DebitNoteItems_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- AutoRenewConfigs_Audit 表：自动续签配置表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[AutoRenewConfigs_Audit]'))
CREATE TABLE [AutoRenewConfigs_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [ContractId] UNIQUEIDENTIFIER , -- 合同ID,
    [IsAutoRenew] BIT , -- 是否自动续签,
    [RenewalDaysBeforeExpiry] INT , -- 提前续签天数,
    [RentAdjustmentPercent] DECIMAL(5,2) , -- 调价百分比,
    [Status] VARCHAR(20) , -- 状态,
    [CompanyId] UNIQUEIDENTIFIER , -- 所属公司ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
...
-- AutoRenewConfigs_Audit 表说明：自动续签配置表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'自动续签配置表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit';
GO

-- AutoRenewConfigs_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否自动续签', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'IsAutoRenew';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'提前续签天数', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'RenewalDaysBeforeExpiry';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'调价百分比', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'RentAdjustmentPercent';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutoRenewConfigs_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_AutoRenewConfigs_Audit_Id_Version] ON [AutoRenewConfigs_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ReceiptAllocations_Audit 表：收据分配表审计
-- ===================================================================
...
CREATE TABLE [ReceiptAllocations_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [ReceiptId] UNIQUEIDENTIFIER , -- 收据ID,
    [ReceivablePlanId] UNIQUEIDENTIFIER , -- 应收计划ID,
...
-- ReceiptAllocations_Audit 表说明：收据分配表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'收据分配表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit';
GO

-- ReceiptAllocations_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'收据ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'ReceiptId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'应收计划ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'ReceivablePlanId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'分配金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'AllocatedAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ReceiptAllocations_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_ReceiptAllocations_Audit_Id_Version] ON [ReceiptAllocations_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- CollectionRecords_Audit 表：催缴记录表审计
-- ===================================================================
...
-- CollectionRecords_Audit 表说明：催缴记录表审计
...
-- CollectionRecords_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'合同ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'ContractId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'阶段编号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'StageNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'发送渠道', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'Channel';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'发送内容', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'Content';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'发送时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'SentAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'OperatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'CreatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'CreatedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新IP', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedIp';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'更新主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CollectionRecords_Audit', @level2type = N'COLUMN', @level2name = N'UpdatedHostname';
GO
...
-- ===================================================================
-- BankMatches_Audit 表：银行匹配记录表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[BankMatches_Audit]'))
CREATE TABLE [BankMatches_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [BankStatementId] UNIQUEIDENTIFIER , -- 银行流水ID,
    [InternalDocumentId] UNIQUEIDENTIFIER , -- 内部单据ID,
    [DocumentType] VARCHAR(20) , -- 单据类型,
    [MatchedAmount] DECIMAL(18,2) , -- 匹配金额,
    [MatchMethod] VARCHAR(20) , -- 匹配方式,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
);
GO

-- BankMatches_Audit 表说明：银行匹配记录表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'银行匹配记录表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit';
GO

-- BankMatches_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'银行流水ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'BankStatementId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'内部单据ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'InternalDocumentId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'单据类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'DocumentType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'匹配金额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'MatchedAmount';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'匹配方式', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'MatchMethod';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankMatches_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_BankMatches_Audit_Id_Version] ON [BankMatches_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- BankReconciliations_Audit 表：银行余额调节表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[BankReconciliations_Audit]'))
CREATE TABLE [BankReconciliations_Audit] (
    [AuditId] BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY , -- 审计自增主键,
    [AuditAction] VARCHAR(20) NOT NULL , -- 审计操作类型,
    [AuditVersionNo] INT NOT NULL , -- 版本号,
    [AuditChangedAt] DATETIME2 NOT NULL , -- 操作时间,
    ...
    [StatementTotal] DECIMAL(18,2) , -- 银行总额,
    [SystemTotal] DECIMAL(18,2) , -- 系统总额,
    [CompletedAt] DATETIME2 , -- 完成时间,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
);
...
-- BankReconciliations_Audit 表说明：银行余额调节表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'银行余额调节表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit';
GO

-- BankReconciliations_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'开始日期', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'StartDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'结束日期', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'EndDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'期初余额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'OpeningBalance';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'期末余额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'ClosingBalance';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'银行总额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'StatementTotal';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'系统总额', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'SystemTotal';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'完成时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'CompletedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BankReconciliations_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_BankReconciliations_Audit_Id_Version] ON [BankReconciliations_Audit]([Id], [AuditVersionNo]);
...
CREATE TABLE [JobSchedules_Audit] (
    ...
    [CronExpression] NVARCHAR(100) , -- Cron表达式,
    [TemplateCode] NVARCHAR(50) , -- 模板代码,
    [IsActive] BIT , -- 是否启用,
    [Description] NVARCHAR(500) , -- 描述,
    [LastRunAt] DATETIME2 , -- 上次执行时间,
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'Cron表达式', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobSchedules_Audit', @level2type = N'COLUMN', @level2name = N'CronExpression';
...
-- ===================================================================
-- JobScheduleExecutions_Audit 表：执行排期表审计
-- ===================================================================
...
CREATE TABLE [JobScheduleExecutions_Audit] (
    ...
    [AuditChangedHostname] VARCHAR(100) , -- 操作人主机名,
    [Id] UNIQUEIDENTIFIER NOT NULL , -- 主键,
    [JobScheduleId] UNIQUEIDENTIFIER , -- 任务定义ID,
    [TargetDate] DATETIME2 , -- 排期执行时间,
    [OriginalDate] DATETIME2 , -- 原始Cron时间,
    [Month] NVARCHAR(7) , -- 所属月份,
    [Status] NVARCHAR(20) , -- 状态,
    [Reason] NVARCHAR(500) , -- 备注,
    [IsAdjusted] BIT , -- 是否手动调整,
    [IsCustom] BIT , -- 是否自定义,
    [CompanyId] UNIQUEIDENTIFIER , -- 所属公司ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 -- 创建时间
...
-- JobScheduleExecutions_Audit 表说明：执行排期表审计
...
-- JobScheduleExecutions_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'任务定义ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'JobScheduleId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'排期执行时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'TargetDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'原始Cron时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'OriginalDate';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属月份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'Month';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'备注', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'Reason';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否手动调整', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'IsAdjusted';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否自定义', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'IsCustom';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'所属公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobScheduleExecutions_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO
...
CREATE TABLE [JobTemplates_Audit] (
    ...
    [DefaultCronExpression] NVARCHAR(100) , -- 默认Cron,
    [Description] NVARCHAR(500) , -- 说明,
    [Icon] NVARCHAR(50) , -- 图标,
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'默认Cron', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'JobTemplates_Audit', @level2type = N'COLUMN', @level2name = N'DefaultCronExpression';
...
CREATE TABLE [HolidayCalendars_Audit] (
    ...
    [Year] INT , -- 年份,
    [HolidayDate] DATE , -- 日期,
    [HolidayName] NVARCHAR(100) , -- 节假日名称,
    [HolidayType] VARCHAR(20) , -- 类型,
    [IsActive] BIT , -- 是否生效,
    [CompanyId] UNIQUEIDENTIFIER , -- 所属公司ID,
    [CreatedBy] UNIQUEIDENTIFIER , -- 创建人,
    [CreatedAt] DATETIME2 , -- 创建时间,
...
-- HolidayCalendars_Audit 表说明：节假日配置表审计
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'年份', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'HolidayCalendars_Audit', @level2type = N'COLUMN', @level2name = N'Year';
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'节假日名称', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'HolidayCalendars_Audit', @level2type = N'COLUMN', @level2name = N'HolidayName';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'HolidayCalendars_Audit', @level2type = N'COLUMN', @level2name = N'HolidayType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否生效', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'HolidayCalendars_Audit', @level2type = N'COLUMN', @level2name = N'IsActive';
...
-- ===================================================================
-- Notifications_Audit 表：站内通知表审计
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id=OBJECT_ID(N'[Notifications_Audit]'))
...
-- Notifications_Audit 表说明：站内通知表审计
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'站内通知表审计', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit';
GO

-- Notifications_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'用户ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'UserId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'公司ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'CompanyId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'通知分类', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'Category';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'标题', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'Title';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'内容', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'Content';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'关联类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'ReferenceType';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'关联ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'ReferenceId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'是否已读', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'IsRead';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Notifications_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO

-- 按记录ID+版本号唯一索引
CREATE UNIQUE INDEX [IX_Notifications_Audit_Id_Version] ON [Notifications_Audit]([Id], [AuditVersionNo]);
...
-- ===================================================================
-- ImportBatchItems_Audit 表：导入明细表审计
-- ===================================================================
...
-- ImportBatchItems_Audit 表说明：导入明细表审计
...
-- ImportBatchItems_Audit 字段说明
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计自增主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'审计操作类型', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditAction';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'版本号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditVersionNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedAt';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'操作人主机名', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'AuditChangedHostname';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'主键', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'Id';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'批次ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'BatchId';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'行号', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'RowNo';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'原始数据', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'RawData';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'状态', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'Status';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'错误信息', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'ErrorMessage';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建人', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedBy';
EXEC sys.sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ImportBatchItems_Audit', @level2type = N'COLUMN', @level2name = N'CreatedAt';
GO
