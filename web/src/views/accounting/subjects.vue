...
async function fetchList() { loading.value = true; try { const r = await getAccountingSubjects(); treeData.value = Array.isArray(r) ? r : [] } catch { ElMessage.error('加载会计科目失败') }; loading.value = false }
